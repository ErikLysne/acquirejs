    ...
    <>
      ...
      >
        ...
        <Typography variant="body1" maxWidth={600}>
          This page demonstrates the mocking abilities of AcquireJS. The switch
          in the toolbar can be used to toggle mocking on and off. When mocking
          is disabled, data is fetched from the{" "}
          <a href="https://jsonplaceholder.typicode.com/">
            JSON Placeholder API
          </a>
          . When mocking is enabled, data is generated by AcquireJS.
        </Typography>
